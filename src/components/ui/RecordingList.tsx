        ...
        {recordings.map((rec) => (
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 14, flex: 1, minWidth: 0 }}>
              <div style={{ width: 44, height: 44, borderRadius: 10, background: rec.status === "READY" ? "#0065b1" : rec.status === "FAILED" ? "#dc2626" : "#ca8a04", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, color: "white", boxShadow: "0 2px 6px rgba(0,0,0,.12)" }}>
                {rec.status === "READY" ? (
